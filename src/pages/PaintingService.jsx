...
import PaintServicesImg2 from "../assets/images/services-page/paint-services-img2.jpg";
import PaintServicesImg3 from "../assets/images/services-page/paint-services-img3.jpg";
import PaintServicesImg4 from "../assets/images/services-page/paint-services-img4.jpg";
    ...
    return (
        <div>
            ...
            <section className="section-one">
                <div className="page-img-header" id="paint-service-bg">
                    <div className="container">
                        <h1 className="img-header-text fade_down">Painting Service</h1>
                        <div className="breadcrumb-group fade_up">
                            <Link to="/">HOME / </Link>
                            <Link to="/Services"> SERVICES /</Link>
                            <Link to="/PaintingService">Painting</Link>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="row">
                        <div className="col-xxl-8 col-xl-8 col-lg-8 col-md-12">
                            ...
                            <img className="plumbing-services-img2 img-animation-style4 reveal"
                                src={PaintServicesImg2} alt="paint-services-img2" />
                            ...
                            <div className="plumbing-grid img-animation-style1 reveal">
                                <img src={PaintServicesImg3} alt="paint-services-img3" />
                                <img src={PaintServicesImg4} alt="paint-services-img4" />
                            </div>
                        ...
                        <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-12">
                            ...
                            <div className="single-services-sub-box">
                                <ul>
                                    ...
                                    <li>
                                        <Link to="/PaintingService" className="current-page-active">Painting Solutions
                                            <img src={RightArrowShort} alt="right-arrow-short" />
                                        </Link>
                                    </li>
                                    <li>
