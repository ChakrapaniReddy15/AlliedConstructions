...
import ElectricalServicesImg2 from "../assets/images/services-page/electrical-services-img2.jpg";
import ElectricalServicesImg3 from "../assets/images/services-page/electrical-services-img3.jpg";
import ElectricalServicesImg4 from "../assets/images/services-page/electrical-services-img4.jpg";
    ...
    return (
        <div>
            ...
            <section className="section-one">
                <div className="page-img-header" id="electrical-service-bg">
                    <div className="container">
                        <h1 className="img-header-text fade_down">Electrical Service</h1>
                        <div className="breadcrumb-group fade_up">
                            <Link to="/">HOME / </Link>
                            <Link to="/Services"> SERVICES /</Link>
                            <Link to="/ElectricalService">Electrical</Link>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-xxl-8 col-xl-8 col-lg-8 col-md-12">
                            ...
                            <img className="plumbing-services-img2 img-animation-style4 reveal"
                                src={ElectricalServicesImg2} alt="electrical-services-img2" />
                            ...
                            <div className="plan-body plumbing-body-list fade_down">
                                <ul>
                                    ...
                                    <li>Condimentum orci consectetur risus vel vitae sit ipsum eu amet. Elit risus scelerisque
                                        sit semper.</li>
                            ...
                            <div className="plumbing-grid img-animation-style1 reveal">
                                <img src={ElectricalServicesImg3} alt="electrical-services-img3" />
                                <img src={ElectricalServicesImg4} alt="electrical-services-img4" />
                            </div>
                        ...
                        <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-12">
                            ...
                            <div className="single-services-sub-box">
                                <ul>
                                    <li className="pt-0">
                                        <Link to="/PlumbingService">Plumbing Solutions
                                    ...
                                    <li>
                                        <Link to="/ElectricalService" className="current-page-active">Electrical Solutions
                                            <img src={RightArrowShort} alt="right-arrow-short" />
                                        </Link>
                                    </li>
                                    <li>
