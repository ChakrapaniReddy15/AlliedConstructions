...
import AirServicesImg2 from "../assets/images/services-page/air-services-img2.jpg";
import AirServicesImg3 from "../assets/images/services-page/air-services-img3.jpg";
import AirServicesImg4 from "../assets/images/services-page/air-services-img4.jpg";
    ...
    return (
        <div>
            ...
            <section className="section-one">
                <div className="page-img-header" id="air-service-bg">
                    <div className="container">
                        <h1 className="img-header-text fade_down">Air Condition Service</h1>
                        <div className="breadcrumb-group fade_up">
                            <Link to="/">HOME / </Link>
                            <Link to="/Services"> SERVICES /</Link>
                            <Link to="/AirConditionService">Air Condition</Link>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="row">
                        <div className="col-xxl-8 col-xl-8 col-lg-8 col-md-12">
                            ...
                            <img className="plumbing-services-img2 img-animation-style4 reveal"
                                src={AirServicesImg2} alt="air-services-img2" />
                            ...
                            <div className="plumbing-grid img-animation-style1 reveal">
                                <img src={AirServicesImg3} alt="air-services-img3" />
                                <img src={AirServicesImg4} alt="air-services-img4" />
                            </div>
                        ...
                        <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-12">
                            ...
                            <div className="single-services-sub-box">
                                <ul>
                                    ...
                                    <li>
                                        <Link to="/AirConditionService" className="current-page-active">Air Condition Solutions
                                            <img src={RightArrowShort} alt="right-arrow-short" />
                                        </Link>
                                    </li>
                                    <li>
