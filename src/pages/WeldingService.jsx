...
import WeldingServicesImg2 from "../assets/images/services-page/welding-services-img2.jpg";
import WeldingServicesImg3 from "../assets/images/services-page/welding-services-img3.jpg";
import WeldingServicesImg4 from "../assets/images/services-page/welding-services-img4.jpg";
    ...
    return (
        <div>
            ...
            <section className="section-one">
                <div className="page-img-header" id="welding-service-bg">
                    <div className="container">
                        <h1 className="img-header-text fade_down">Welding Service</h1>
                        <div className="breadcrumb-group fade_up">
                            <Link to="/">HOME / </Link>
                            <Link to="/Services"> SERVICES /</Link>
                            <Link to="/WeldingService">Welding</Link>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="row">
                        <div className="col-xxl-8 col-xl-8 col-lg-8 col-md-12">
                            ...
                            <img className="plumbing-services-img2 img-animation-style4 reveal"
                                src={WeldingServicesImg2} alt="welding-services-img2" />
                            ...
                            <div className="plumbing-grid img-animation-style1 reveal">
                                <img src={WeldingServicesImg3} alt="welding-services-img3" />
                                <img src={WeldingServicesImg4} alt="welding-services-img4" />
                            </div>
                            ...
                            <div className="single-services-sub-box">
                                <ul>
                                    ...
                                    <li className="pb-0 border-bottom-0">
                                        <Link to="/WeldingService" className="current-page-active">Welding Solutions
                                            <img src={RightArrowShort} alt="right-arrow-short" />
                                        </Link>
                                    </li>
                                </ul>
