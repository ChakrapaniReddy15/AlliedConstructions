...
import CarpentryServicesImg2 from "../assets/images/services-page/carpentry-services-img2.jpg";
import CarpentryServicesImg3 from "../assets/images/services-page/plumbing-services-img3.jpg";
import CarpentryServicesImg4 from "../assets/images/services-page/plumbing-services-img4.jpg";
    ...
    return (
        <div>
            ...
            <section className="section-one">
                <div className="page-img-header" id="carpentry-service-bg">
                    <div className="container">
                        <h1 className="img-header-text fade_down">Carpentry Service</h1>
                        <div className="breadcrumb-group fade_up">
                            <Link to="/">HOME / </Link>
                            <Link to="/Services"> SERVICES /</Link>
                            <Link to="/CarpentryService"> Carpentry</Link>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="row">
                        <div className="col-xxl-8 col-xl-8 col-lg-8 col-md-12">
                            ...
                            <img className="plumbing-services-img2 img-animation-style4 reveal"
                                src={CarpentryServicesImg2} alt="carpentry-services-img2" />
                            ...
                            <div className="plumbing-grid img-animation-style1 reveal">
                                <img src={CarpentryServicesImg3} alt="carpentry-services-img3" />
                                <img src={CarpentryServicesImg4} alt="carpentry-services-img4" />
                            </div>
                        ...
                        <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-12">
                            ...
                            <div className="single-services-sub-box">
                                <ul>
                                    ...
                                    <li>
                                        <Link to="/CarpentryService" className="current-page-active">Carpentry Solutions
                                            <img src={RightArrowShort} alt="right-arrow-short" />
                                        </Link>
                                    </li>
                                    <li>
