...
import CleaningServicesImg2 from "../assets/images/services-page/cleaning-services-img2.jpg";
import CleaningServicesImg3 from "../assets/images/services-page/cleaning-services-img3.jpg";
import CleaningServicesImg4 from "../assets/images/services-page/cleaning-services-img4.jpg";
    ...
    return (
        <div>
            ...
            <section className="section-one">
                <div className="page-img-header" id="cleaning-service-bg">
                    <div className="container">
                        <h1 className="img-header-text fade_down">Cleaning Service</h1>
                        <div className="breadcrumb-group fade_up">
                            <Link to="/">HOME / </Link>
                            <Link to="/Services"> SERVICES /</Link>
                            <Link to="/CleaningService">Cleaning</Link>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="row">
                        <div className="col-xxl-8 col-xl-8 col-lg-8 col-md-12">
                            ...
                            <img className="plumbing-services-img2 img-animation-style4 reveal"
                                src={CleaningServicesImg2} alt="cleaning-services-img2" />
                            ...
                            <div className="plumbing-grid img-animation-style1 reveal">
                                <img src={CleaningServicesImg3} alt="cleaning-services-img3" />
                                <img src={CleaningServicesImg4} alt="cleaning-services-img4" />
                            </div>
                        ...
                        <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-12">
                            ...
                            <div className="single-services-sub-box">
                                <ul>
                                    ...
                                    <li>
                                        <Link to="/CleaningService" className="current-page-active">Cleaning Solutions
                                            <img src={RightArrowShort} alt="right-arrow-short" />
                                        </Link>
                                    </li>
                                    <li>
